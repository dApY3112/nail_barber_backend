"""Adjust reviews functions

Revision ID: 4bb4de028285
Revises: 3551005398fe
Create Date: 2025-05-30 12:44:40.760262
...
revision: str = '4bb4de028285'
down_revision: Union[str, None] = '3551005398fe'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], name=op.f('ratings_service_id_fkey')),
