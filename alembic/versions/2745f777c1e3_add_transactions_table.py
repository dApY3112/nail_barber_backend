...
Revision ID: 2745f777c1e3
Revises: c3d9b543eb97
Create Date: 2025-05-29 21:24:43.807155
...
revision: str = '2745f777c1e3'
down_revision: Union[str, None] = 'c3d9b543eb97'
...
def upgrade() -> None:
    ...
    op.add_column('providers', sa.Column('city', sa.String(length=255), nullable=True))
    op.add_column('providers', sa.Column('country', sa.String(length=255), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('providers', sa.Column('latitude', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('providers', sa.Column('longitude', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
